...
pf2576_config() {
  ...
  PF2576_MERGE_COMMIT="${PAPERSFLOW_PF2576_MERGE_COMMIT:-c5f8451568b794bb4b274dc9cfd0c87ac6799107}"
  ...
  PF2576_REVIEWED_TREE="${PAPERSFLOW_PF2576_REVIEWED_TREE:-d4964f4c188a7daf2c2f2616a107940cad825514}"
  readonly \
