...
pf3375_config() {
  ...
  PF3375_MERGE_COMMIT="${PAPERSFLOW_PF3375_MERGE_COMMIT:-03b9381ad3fe456c755b712ede419cd4272df494}"
  ...
  PF3375_REVIEWED_TREE="${PAPERSFLOW_PF3375_REVIEWED_TREE:-efaecc99595e92806eeaf5340c70ebd4a0344f38}"
  readonly \
