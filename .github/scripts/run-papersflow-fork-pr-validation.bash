...
pf2576_config() {
  ...
  PF2576_MERGE_COMMIT="${PAPERSFLOW_PF2576_MERGE_COMMIT:-243af199dfe170ab9d5daa7748a730c41ec38504}"
  ...
  PF2576_REVIEWED_TREE="${PAPERSFLOW_PF2576_REVIEWED_TREE:-659342e4d9dfc6731a529d71a3bb7df571f1c75e}"
  readonly \
