...
pf3375_config() {
  ...
  PF3375_MERGE_COMMIT="${PAPERSFLOW_PF3375_MERGE_COMMIT:-2358c17012f7f21d7e2736f39e4c85c09df9194a}"
  ...
  PF3375_REVIEWED_TREE="${PAPERSFLOW_PF3375_REVIEWED_TREE:-ef04ad8a7c3f80ac7e3c33b25b6df6f0f3666f88}"
  readonly \
