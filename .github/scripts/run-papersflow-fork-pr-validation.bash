...
pf2576_config() {
  ...
  PF2576_MERGE_COMMIT="${PAPERSFLOW_PF2576_MERGE_COMMIT:-e8b60473d3e53c81444be67db98b869c122269dc}"
  ...
  PF2576_REVIEWED_TREE="${PAPERSFLOW_PF2576_REVIEWED_TREE:-133df4fbf80b885e597cb253bbebd4c8d21753b4}"
  readonly \
