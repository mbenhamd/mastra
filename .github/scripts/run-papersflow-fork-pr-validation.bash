...
pf3375_config() {
  ...
  PF3375_MERGE_COMMIT="${PAPERSFLOW_PF3375_MERGE_COMMIT:-f32f93bf8ac30ba6c18f7f5f9a46e4068404316c}"
  ...
  PF3375_REVIEWED_TREE="${PAPERSFLOW_PF3375_REVIEWED_TREE:-74b90d7190720b2bd0e77d2fcbdef3ccce6551fc}"
  readonly \
