...
pf3375_config() {
  ...
  PF3375_MERGE_COMMIT="${PAPERSFLOW_PF3375_MERGE_COMMIT:-a5a64b9c759ef8bdf679bba2efa5a8f8d7bf2f77}"
  ...
  PF3375_REVIEWED_TREE="${PAPERSFLOW_PF3375_REVIEWED_TREE:-89ae01236156d256935cc195ef6f96dfa28a7e46}"
  readonly \
