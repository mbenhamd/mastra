...
pf3759_config() {
  ...
  PF3759_MERGE_COMMIT="${PAPERSFLOW_PF3759_MERGE_COMMIT:-ea84f875510fac285a6313570df8cbf0d32c2c4f}"
  ...
  PF3759_REVIEWED_TREE="${PAPERSFLOW_PF3759_REVIEWED_TREE:-dde12627a858d922bc43eb29646d0e81408efdf5}"
  readonly \
