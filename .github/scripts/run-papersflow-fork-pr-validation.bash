...
pf3020_config() {
  ...
  PF3020_MERGE_COMMIT="${PAPERSFLOW_PF3020_MERGE_COMMIT:-c2876ce83861927c34bf59954b6017a0e39607c0}"
  ...
  PF3020_REVIEWED_TREE="${PAPERSFLOW_PF3020_REVIEWED_TREE:-66cf5f0743660f15455b42da324aec7da10fb30a}"
  readonly \
