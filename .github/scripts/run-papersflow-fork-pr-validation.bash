...
pf3375_config() {
  ...
  PF3375_MERGE_COMMIT="${PAPERSFLOW_PF3375_MERGE_COMMIT:-6b97c62cdcf83c7f069b5aa66ff1ba0f149b56cb}"
  ...
  PF3375_REVIEWED_TREE="${PAPERSFLOW_PF3375_REVIEWED_TREE:-e6c7f356fc42325d7d175d4c31210e7aff01d314}"
  readonly \
