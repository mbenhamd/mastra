...
pf2576_config() {
  ...
  PF2576_MERGE_COMMIT="${PAPERSFLOW_PF2576_MERGE_COMMIT:-39d3e3387d301c03be8a08edc7b91df23a9a83dd}"
  ...
  PF2576_REVIEWED_TREE="${PAPERSFLOW_PF2576_REVIEWED_TREE:-612bced4b94fa11b7b90c696b975f1b1ea82eaf0}"
  readonly \
