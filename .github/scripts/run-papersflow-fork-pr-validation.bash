...
pf3020_config() {
  ...
  PF3020_MERGE_COMMIT="${PAPERSFLOW_PF3020_MERGE_COMMIT:-bdddbecd8e34930d96cc0f81bdaea856900f93fe}"
  ...
  PF3020_REVIEWED_TREE="${PAPERSFLOW_PF3020_REVIEWED_TREE:-b5c5b7603f7b145feca508576c32431fa3d6c5c3}"
  readonly \
