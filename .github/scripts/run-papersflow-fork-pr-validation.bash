...
pf3020_config() {
  ...
  PF3020_MERGE_COMMIT="${PAPERSFLOW_PF3020_MERGE_COMMIT:-43549721645054553f6176fa343b9f9e2b751363}"
  ...
  PF3020_REVIEWED_TREE="${PAPERSFLOW_PF3020_REVIEWED_TREE:-80c0f68cf9095fbae8a87960e116bf235d16f9bd}"
  readonly \
