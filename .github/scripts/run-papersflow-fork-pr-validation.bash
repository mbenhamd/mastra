...
pf2576_config() {
  ...
  PF2576_MERGE_COMMIT="${PAPERSFLOW_PF2576_MERGE_COMMIT:-2e79808f96838cc3357222058abfc78a57ac12e9}"
  ...
  PF2576_REVIEWED_TREE="${PAPERSFLOW_PF2576_REVIEWED_TREE:-bf6fefa30a61363089f4bf82c2cf7a9f99851d28}"
  readonly \
