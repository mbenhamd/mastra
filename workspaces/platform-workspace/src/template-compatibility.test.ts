...
type SetWorkdirAcceptsE2BStringPath = Expect<
  Parameters<SandboxTemplateBuilder['setWorkdir']>[0] extends Parameters<E2BTemplateBuilder['setWorkdir']>[0]
    ...
    : false
>;
type SetEnvsAcceptsE2BArguments = Expect<
  Parameters<E2BTemplateBuilder['setEnvs']> extends Parameters<SandboxTemplateBuilder['setEnvs']> ? true : false
>;
