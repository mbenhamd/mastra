...
Before pushing commits or opening PRs, run the narrowest relevant local checks, `pnpm prettier:changed`, and `pnpm lint`; run a local CodeRabbit review when the CLI is installed and configured.
