...
- `deleteResource({ resourceId })`: Delete a resource record and its working memory without inspecting or mutating threads, messages, observational-memory records, or thread metadata
