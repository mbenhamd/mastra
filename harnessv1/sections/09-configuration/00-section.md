...
**Entity ownership:** Harness (`HarnessConfig`), Storage, Memory, Workers;
heartbeat handlers are live-layer only — [§0 Mental model](../00-mental-model.md).
...
<figure>
  <svg role="img" aria-labelledby="hx-config-title hx-config-desc" viewBox="0 0 1080 600" width="100%" style="max-width: 1100px; height: auto; display: block; margin: 1.5rem auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 18px; padding: 16px; box-sizing: border-box;">
    ...
    <text style="font: 600 18px system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, sans-serif; fill: #0f172a;" x="170" y="512" text-anchor="middle">Runtime generation</text>
    <text style="font: 500 14px system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, sans-serif; fill: #475569;" x="170" y="533" text-anchor="middle">drift protection</text>
