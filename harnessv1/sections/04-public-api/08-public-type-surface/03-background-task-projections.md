...
// completion fields but shares the status taxonomy 1:1. This is deliberately
// separate from `DurableWorkStatus`, which is only the `DurableWorkSummary`
// read-model vocabulary. Any change to the literal set is a public-API change
// governed by §11.6.
