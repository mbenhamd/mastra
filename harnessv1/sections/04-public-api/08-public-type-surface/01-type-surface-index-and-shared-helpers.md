...
//   file-attachment option objects: SignalOptions, QueueOptions,
...
//   HarnessWorkspaceConfig; §10 owns HarnessEventV1; §13.3 owns the shared wire
//   DTOs and envelopes it declares, including WireSchemaRef,
//   WireSchemaDescriptor, WireHarnessSkillDescriptor, WireListPage,
//   SignalRequest, SkillInvocationRequest, WireAttachment,
//   SignalAdmissionResponse, QueueAdmissionResponse, SignalResultResponse,
...
// method shape and namespace-binding contract; this facade must delegate to the
// canonical MemoryStorage, ChannelsStorage, BackgroundTasksStorage, scheduler,
// PubSub/cache, and BlobStore owners instead of cloning those domains.
// This is not a remote SDK surface and not an alias to current deprecated
