...
**Canonical admission identity.** Hash inputs, serializability restrictions,
duplicate/conflict behavior, and option-field rules for `admissionId` on
`signal`, `queue`, and untyped `useSkill` are defined in
[§4.4b](02-queue-and-skill-options.md). Durable receipts, tombstones, and
retention live in [§5.1d](../../05-session-persistence/01-what-gets-persisted/10-queue-admission-and-tombstones.md).
§3, §13, and §15 reference these owners and must not redefine hash inputs or
storage lifecycle.
...
<figure>
  <svg role="img" aria-labelledby="hx-operation-options-title hx-operation-options-desc" viewBox="0 0 1060 500" width="100%" style="max-width: 1100px; height: auto; display: block; margin: 1.5rem auto; background: #ffffff; border: 1px solid #e2e8f0; border-radius: 18px; padding: 16px; box-sizing: border-box;">
    ...
    <desc id="hx-operation-options-desc">Signal, queue, and skill options share serializable overrides, request context, tracing, file attachments, and admission ID hashing, with sync output and addTools restricted to specific paths.</desc>
    <defs>
    ...
    <text style="font: 500 13.5px system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, sans-serif; fill: #475569;" x="530" y="76" text-anchor="middle">signal / queue / skill</text>

    <rect style="fill: #f8fafc; stroke: #94a3b8; stroke-width: 2; rx: 14;" x="70" y="150" width="200" height="68" />
    <text style="font: 600 17px system-ui, -apple-system, BlinkMacSystemFont, Segoe UI, sans-serif; fill: #0f172a;" x="170" y="178" text-anchor="middle">SignalOptions</text>
