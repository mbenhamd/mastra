...
This boundary is a narrow adapter over existing agent/workflow resume APIs such
as stream/generate resume and tool approval/decline. It adds idempotency and
result lookup around those APIs; it must not move workflow snapshot ownership,
pending tool semantics, or resume execution into Harness.
