...
**Entity ownership:** cross-cutting checks on Storage, Session, Workers, and
live-layer fences — [§0 Mental model](../00-mental-model.md). §15.2 acceptance
criteria are target v1 behavior; see its implementation-status preamble.
