...
operation, but clients still settle signal/queue promises through the result
lookup routes, channel diagnostics for channel-specific inspection, and
operator-only background-task diagnostics for task-specific inspection.
