    ...
    properties: [
      {
        ...
        parameters: [
          ...
          },
          {
            ...
            type: 'boolean',
            isOptional: true,
            description: 'Whether the tool call was declined through an approval flow before the tool executed.',
          },
          {
            name: 'deniedReason',
            type: 'string',
            isOptional: true,
            description: 'Reason for the declined tool approval, when available.',
          },
          {
            name: 'providerExecuted',
            type: 'boolean',
...
Emitted when a tool call is dispatched as a [background task](/docs/agents/background-tasks) and `streamUntilIdle()` is used.
