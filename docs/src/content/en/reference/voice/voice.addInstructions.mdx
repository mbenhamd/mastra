...
description: "The addInstructions() method equips a voice provider with instructions that guide the model's behavior during real-time interactions."
packages:
  - "@mastra/core"
...
const voice = new OpenAIRealtimeVoice({
  realtimeConfig: {
    model: '__AI_SDK_OPENAI_MODEL_REALTIME__',
