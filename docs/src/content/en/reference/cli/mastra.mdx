...
Switches the active organization through an interactive prompt. This command can't be used when `MASTRA_API_TOKEN` or `MASTRA_ORG_ID` environment variables are set.
