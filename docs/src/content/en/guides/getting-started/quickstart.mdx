...
For more control, see the [manual installation guide](/docs/getting-started/manual-install). To add Mastra to an existing project, use [`mastra init`](/reference/cli/mastra#mastra-init).
...
- Learn how to [build Mastra with AI](/docs/getting-started/build-with-ai)
