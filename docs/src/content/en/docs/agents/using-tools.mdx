...
The projected canonical JSON defaults to a 16 KiB UTF-8 limit and cannot exceed 64 KiB. Keep large artifacts in durable storage and return identifiers plus a concise summary.
