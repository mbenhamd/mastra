...
<CopyPrompt identifier="manual-install">
  Read [https://mastra.ai/docs/getting-started/manual-install.md](https://mastra.ai/docs/getting-started/manual-install.md) and then help me create my Mastra project. Ask me what I want to call my project and use this as the folder name.
</CopyPrompt>
