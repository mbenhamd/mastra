...
When the agent uses the `stagehand_screenshot` tool, it captures a PNG of the current page and returns it as image content that vision-capable models can interpret directly.
