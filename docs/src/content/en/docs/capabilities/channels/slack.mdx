...
To connect your agent, create a Slack app in the workspace where you want it to run. The Slack app controls how your agent is presented in Slack, what it can do, and which events it receives.
