...
This is an at-least-once transport contract. Broker-owned attempts prevent a fresh source budget, but exactly-once parent and finish notifications require a durable terminalization journal. Terminal notification consumers should remain idempotent.
