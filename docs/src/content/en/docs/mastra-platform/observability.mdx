...
See [Mastra platform configuration](/docs/mastra-platform/configuration#environment-variables) for the environment variables used by platform observability.
