...
The Harness is a session controller for building interactive agent applications. Its runtime responsibilities between your UI and the agent loop include conversation thread management, state persistence, agent mode switching, tool approval gates, and subagent coordination. You can focus on what your agent does rather than how to wire it together.
