...
description: "Configure Mastra storage with Cloudflare KV or Durable Objects, choosing eventual or strong consistency, Worker bindings, REST access, and key namespaces."
packages:
  - "@mastra/cloudflare"
---
