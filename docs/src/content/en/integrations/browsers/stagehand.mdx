...
description: "Automate browsers from Mastra agents with Stagehand using natural-language actions, structured extraction, observed actions, screenshots, and Browserbase."
packages:
  - "@mastra/stagehand"
---
...
This adds `browser_record` and `browser_record_caption` to the agent's toolset. See [Browser recording (alpha)](/docs/browser#record-browser-sessions) for details.
