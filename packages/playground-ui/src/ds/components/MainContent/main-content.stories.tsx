...
export const Default: Story = {
  render: () => (
    <MainContentLayout className="h-100 bg-surface1">
      <PageHeader>
    ...
    <MainContentLayout className="h-100 bg-surface1">
      ...
      <MainContentContent isCentered>
        <div className="text-center">
          <p className="text-lg text-neutral5">No items found</p>
          <p className="text-sm text-neutral3">Create your first item to get started</p>
        </div>
      </MainContentContent>
    </MainContentLayout>
  ),
  ...
  render: () => (
    <MainContentLayout className="h-100 bg-surface1">
      ...
      <MainContentContent isDivided>
        <div className="border-r border-border1 p-4">
  ...
  render: () => (
    <MainContentLayout className="h-100 bg-surface1">
      ...
      <MainContentContent hasLeftServiceColumn>
        <div className="border-r border-border1 bg-surface2 p-2">
          <p className="text-sm text-neutral3">Nav</p>
        </div>
        <div className="p-4">
