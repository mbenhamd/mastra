...
export const Default: Story = {
  args: {
    iconSlot: <Inbox className="h-auto w-[126px] text-neutral3" />,
...
export const NoResults: Story = {
  args: {
    iconSlot: <Search className="h-auto w-[126px] text-neutral3" />,
...
export const NoFiles: Story = {
  args: {
    iconSlot: <FileX className="h-auto w-[126px] text-neutral3" />,
    titleSlot: 'No files',
...
export const NoTeamMembers: Story = {
  args: {
    iconSlot: <Users className="h-auto w-[126px] text-neutral3" />,
