...
// agent-agnostic: they do not depend on the Harness or the AgentController.
// The task list is persisted
 ...
 * `RequestContext`, and emit the Harness/AgentController display update.
 */
